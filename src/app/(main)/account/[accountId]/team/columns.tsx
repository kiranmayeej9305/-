...
import { UsersWithAccountChatbotPermissionsSidebarOptions } from '@/lib/types'
import CustomModal from '@/components/global/custom-modal'

export const columns: ColumnDef<UsersWithAccountChatbotPermissionsSidebarOptions>[] =
  [
    {
      accessorKey: 'id',
      header: '',
...

    {
      ...
      cell: ({ row }) => {
        const isAccountOwner = row.getValue('role') === 'ACCOUNT_OWNER'
...
interface CellActionsProps {
  rowData: UsersWithAccountChatbotPermissionsSidebarOptions
}
        ...
        <DropdownMenuContent align="end">
          ...
          <DropdownMenuItem
            ...
            onClick={() => {
              setOpen(
                <CustomModal
                  subheading="You can change permissions only when the user has an owned Chatbot"
                  title="Edit User Details"
                >
                  <UserDetails
                    type="account"
                    id={rowData?.Account?.id || null}
                    chatbots={rowData?.Account?.Chatbot}
                  />
                </CustomModal>,
                async () => {
          ...
          <AlertDialogAction
            ...
            onClick={async () => {
              ...
              toast({
                title: 'Deleted User',
                description:
                  'The user has been deleted from this account they no longer have access to the account',
              })
              setLoading(false)
              router.refresh()
            }}

...
const ChatbotPageId = async ({ params, searchParams }: Props) => {
  let currency = 'USD'
  let sessions
  ...
  if (chatbotDetails.connectAccountId) {
    const response = await stripe.accounts.retrieve({
      stripeAccount: chatbotDetails.connectAccountId,
    })
      ...
      <div className="relative h-full">
        <div className="flex flex-col gap-4 pb-6">
          <div className="flex gap-4 flex-col xl:!flex-row">
            ...
            <PipelineValue chatbotId={params.chatbotId} />

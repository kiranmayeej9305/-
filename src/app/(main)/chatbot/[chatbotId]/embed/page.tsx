...
defer>
  ...
  const shareLink = `https://www.chatbase.co/chatbot-iframe/${chatbotId}`;
        ...
        <div className="w-full max-w-[800px]">
          <Card className="border-none">
            <CardHeader>
              ...
              <CardDescription>
                Add the chatbot to your website using the iframe code or the chat bubble script tag.
              </CardDescription>
            </CardHeader>
            <CardContent className="flex flex-col gap-6">
              ...
              <div>
                ...
                <Separator className="my-2" />
                <p className="mb-2">
                  Use this link to share your chatbot with others:
                </p>
                <div className="relative bg-muted p-4 rounded-md">
              ...
              <div className="flex justify-between items-center mt-6">
                <Button asChild variant="link">
                  <a
                    href={`https://www.chatbase.co/chatbot-iframe/${chatbotId}`}
                    target="_blank"

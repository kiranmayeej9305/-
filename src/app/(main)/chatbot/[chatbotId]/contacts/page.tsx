...
import { Contact, Chatbot, Ticket } from '@prisma/client'
...
const ContactPage = async ({ params }: Props) => {
  type ChatbotWithContacts = Chatbot & {
    Contact: (Contact & { Ticket: Ticket[] })[]
  }

  const contacts = (await db.Chatbot.findUnique({
    where: {
      id: params.chatbotId,
    },
  ...
  return (
    <BlurPage>
      ...
      <CraeteContactButton chatbotId={params.chatbotId} />
      <Table>
        <TableHeader>
          <TableRow>

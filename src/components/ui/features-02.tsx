      ...
      <div className="py-12 md:py-20">
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          <div className="relative max-w-3xl mx-auto text-center pb-12 md:pb-20">
            <h2 className="font-inter-tight text-3xl md:text-4xl font-bold text-zinc-900 dark:text-zinc-100 mb-4">AI-powered features and effects</h2>
          ...
          <div className="max-w-xs mx-auto sm:max-w-none grid sm:grid-cols-2 md:grid-cols-3 gap-8 sm:gap-4 lg:gap-8">
            <article className="sm:col-span-2 flex flex-col border border-transparent [background:linear-gradient(theme(colors.white),theme(colors.zinc.50))_padding-box,linear-gradient(120deg,theme(colors.zinc.300),theme(colors.zinc.100),theme(colors.zinc.300))_border-box] dark:[background:linear-gradient(theme(colors.zinc.800),theme(colors.zinc.800))_padding-box,linear-gradient(120deg,theme(colors.zinc.500),theme(colors.zinc.700),theme(colors.zinc.500))_border-box] rounded-lg">
              <div className="grow flex flex-col p-5 pt-6">
                <div className="flex items-center space-x-3 mb-1">
                  <svg className="inline-flex fill-zinc-400 dark:fill-zinc-600" xmlns="http://www.w3.org/2000/svg" width="20" height="20">
                  ...
                  <h3 className="font-inter-tight font-semibold text-zinc-900 dark:text-zinc-100">Truly Collaborative</h3>
                </div>
                <p className="grow max-w-md text-sm text-zinc-500 dark:text-zinc-300">
            ...
            <article className="flex flex-col border border-transparent [background:linear-gradient(theme(colors.white),theme(colors.zinc.50))_padding-box,linear-gradient(120deg,theme(colors.zinc.300),theme(colors.zinc.100),theme(colors.zinc.300))_border-box] dark:[background:linear-gradient(theme(colors.zinc.800),theme(colors.zinc.800))_padding-box,linear-gradient(120deg,theme(colors.zinc.500),theme(colors.zinc.700),theme(colors.zinc.500))_border-box] rounded-lg">
              <div className="grow flex flex-col p-5 pt-6">
                <div className="flex items-center space-x-3 mb-1">
                  <svg className="inline-flex fill-zinc-400 dark:fill-zinc-600" xmlns="http://www.w3.org/2000/svg" width="20" height="20">
                  ...
                  <h3 className="font-inter-tight font-semibold text-zinc-900 dark:text-zinc-100">Advanced AI</h3>
                </div>
                <p className="grow max-w-md text-sm text-zinc-500 dark:text-zinc-300">
            ...
            <article className="flex flex-col border border-transparent [background:linear-gradient(theme(colors.white),theme(colors.zinc.50))_padding-box,linear-gradient(120deg,theme(colors.zinc.300),theme(colors.zinc.100),theme(colors.zinc.300))_border-box] dark:[background:linear-gradient(theme(colors.zinc.800),theme(colors.zinc.800))_padding-box,linear-gradient(120deg,theme(colors.zinc.500),theme(colors.zinc.700),theme(colors.zinc.500))_border-box] rounded-lg">
              <div className="grow flex flex-col p-5 pt-6">
                <div className="flex items-center space-x-3 mb-1">
                  ...
                  <h3 className="font-inter-tight font-semibold text-zinc-900 dark:text-zinc-100">Simple Snippets</h3>
                </div>
                <p className="grow max-w-md text-sm text-zinc-500 dark:text-zinc-300">
            ...
            <article className="flex flex-col border border-transparent [background:linear-gradient(theme(colors.white),theme(colors.zinc.50))_padding-box,linear-gradient(120deg,theme(colors.zinc.300),theme(colors.zinc.100),theme(colors.zinc.300))_border-box] dark:[background:linear-gradient(theme(colors.zinc.800),theme(colors.zinc.800))_padding-box,linear-gradient(120deg,theme(colors.zinc.500),theme(colors.zinc.700),theme(colors.zinc.500))_border-box] rounded-lg">
              <div className="grow flex flex-col p-5 pt-6">
                <div className="flex items-center space-x-3 mb-1">
                  ...
                  <h3 className="font-inter-tight font-semibold text-zinc-900 dark:text-zinc-100">Precise Activity</h3>
                </div>
                <p className="grow max-w-md text-sm text-zinc-500 dark:text-zinc-300">
            ...
            <article className="flex flex-col border border-transparent [background:linear-gradient(theme(colors.white),theme(colors.zinc.50))_padding-box,linear-gradient(120deg,theme(colors.zinc.300),theme(colors.zinc.100),theme(colors.zinc.300))_border-box] dark:[background:linear-gradient(theme(colors.zinc.800),theme(colors.zinc.800))_padding-box,linear-gradient(120deg,theme(colors.zinc.500),theme(colors.zinc.700),theme(colors.zinc.500))_border-box] rounded-lg">
              <div className="grow flex flex-col p-5 pt-6">
                <div className="flex items-center space-x-3 mb-1">
                  ...
                  <h3 className="font-inter-tight font-semibold text-zinc-900 dark:text-zinc-100">Real-time Feedback</h3>
                </div>
                <p className="grow max-w-md text-sm text-zinc-500 dark:text-zinc-300">

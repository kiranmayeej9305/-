          ...
          <div className="lg:flex space-y-12 lg:space-y-0 lg:space-x-12 xl:space-x-24">
            ...
            <div className="lg:max-w-none lg:min-w-[524px]">
              <div className="mb-8">
                ...
                <h3 className="font-inter-tight text-3xl font-bold text-zinc-900 dark:text-zinc-100 mb-4">Design-powered workflows for teams of any size</h3>
                <p className="text-lg text-zinc-500 dark:text-zinc-300">Gray can understand what you are designing, learn from your feedback to take your creativity further, and turn it instantly into beautiful images.</p>
              </div>
              {/* Tabs buttons */}
              <div className="mb-8 md:mb-0 space-y-2">
                <button
                  className={`text-left flex items-center px-6 py-4 rounded border border-transparent ${tab !== 1 ? 'bg-zinc-100 dark:bg-zinc-800 opacity-60 hover:opacity-100 transition' : '[background:linear-gradient(#ffffff,#ffffff)_padding-box,linear-gradient(120deg,theme(colors.zinc.300),theme(colors.zinc.100),theme(colors.zinc.300))_border-box] dark:[background:linear-gradient(theme(colors.zinc.800),theme(colors.zinc.800))_padding-box,linear-gradient(120deg,theme(colors.zinc.500),theme(colors.zinc.700),theme(colors.zinc.500))_border-box] shadow-sm rotate-1'}`}
                  onClick={(e) => { e.preventDefault(); setTab(1); }}
                >
                  <svg className="shrink-0 fill-zinc-400 dark:fill-zinc-600 mr-3" xmlns="http://www.w3.org/2000/svg" width="24" height="24">
                  ...
                  <div>
                    <div className="font-inter-tight text-lg font-semibold text-zinc-900 dark:text-zinc-100 mb-1">Make designs feel real</div>
                    <div className="text-zinc-500 dark:text-zinc-400">Save time and keep things consistent with reusable images, and 3D assets in shared libraries.</div>
                  </div>
                </button>
                <button
                  className={`text-left flex items-center px-6 py-4 rounded border border-transparent ${tab !== 2 ? 'bg-zinc-100 dark:bg-zinc-800 opacity-60 hover:opacity-100 transition' : '[background:linear-gradient(#ffffff,#ffffff)_padding-box,linear-gradient(120deg,theme(colors.zinc.300),theme(colors.zinc.100),theme(colors.zinc.300))_border-box] dark:[background:linear-gradient(theme(colors.zinc.800),theme(colors.zinc.800))_padding-box,linear-gradient(120deg,theme(colors.zinc.500),theme(colors.zinc.700),theme(colors.zinc.500))_border-box] shadow-sm rotate-1'}`}
                ...
                >
                  ...
                  <div>
                    <div className="font-inter-tight text-lg font-semibold text-zinc-900 dark:text-zinc-100 mb-1">Bring creatives closer</div>
                    <div className="text-zinc-500 dark:text-zinc-400">Save time and keep things consistent with reusable images, and 3D assets in shared libraries.</div>
                  </div>
                </button>
                <button
                  className={`text-left flex items-center px-6 py-4 rounded border border-transparent ${tab !== 3 ? 'bg-zinc-100 dark:bg-zinc-800 opacity-60 hover:opacity-100 transition' : '[background:linear-gradient(#ffffff,#ffffff)_padding-box,linear-gradient(120deg,theme(colors.zinc.300),theme(colors.zinc.100),theme(colors.zinc.300))_border-box] dark:[background:linear-gradient(theme(colors.zinc.800),theme(colors.zinc.800))_padding-box,linear-gradient(120deg,theme(colors.zinc.500),theme(colors.zinc.700),theme(colors.zinc.500))_border-box] shadow-sm rotate-1'}`}
                ...
                >
                  ...
                  <div>
                    <div className="font-inter-tight text-lg font-semibold text-zinc-900 dark:text-zinc-100 mb-1">Scale and align your design team</div>
                    <div className="text-zinc-500 dark:text-zinc-400">Save time and keep things consistent with reusable images, and 3D assets in shared libraries.</div>
                  </div>
                </button>
              </div>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-8 lg:gap-16">
            ...
            <div>
              <div className="flex items-center mb-1">
                ...
                <h3 className="font-inter-tight font-semibold text-zinc-900 dark:text-zinc-100">Discussions</h3>
              </div>
              <p className="text-sm text-zinc-500 dark:text-zinc-300">Keep workflows efficient with tools that give teams visibility throughout the process.</p>
            </div>
            {/* Block #2 */}
            <div>
              <div className="flex items-center mb-1">
                ...
                <h3 className="font-inter-tight font-semibold text-zinc-900 dark:text-zinc-100">Team views</h3>
              </div>
              <p className="text-sm text-zinc-500 dark:text-zinc-300">Keep workflows efficient with tools that give teams visibility throughout the process.</p>
            </div>
            {/* Block #3 */}
            <div>
              <div className="flex items-center mb-1">
                ...
                <h3 className="font-inter-tight font-semibold text-zinc-900 dark:text-zinc-100">Powerful search</h3>
              </div>
              <p className="text-sm text-zinc-500 dark:text-zinc-300">Keep workflows efficient with tools that give teams visibility throughout the process.</p>
            </div>
            {/* Block #4 */}
            <div>
              <div className="flex items-center mb-1">
                ...
                <h3 className="font-inter-tight font-semibold text-zinc-900 dark:text-zinc-100">Enhancing</h3>
              </div>
              <p className="text-sm text-zinc-500 dark:text-zinc-300">Keep workflows efficient with tools that give teams visibility throughout the process.</p>
            </div>
            {/* Block #5 */}

        ...
        <div className="px-4 sm:px-6">
          <div className="max-w-3xl mx-auto">
            <div className="text-center pb-12 md:pb-16">
              <h1
                className="text-5xl md:text-6xl font-bold leading-tight bg-clip-text text-transparent bg-gradient-to-r from-zinc-700 via-zinc-900 to-zinc-700 dark:from-zinc-300 dark:via-zinc-600 dark:to-zinc-400 pb-4"
                style={{ fontFamily: 'Montserrat, sans-serif' }}
              >
                <span style={{ fontFamily: 'Montserrat, sans-serif' }}>Empower Your Business with Custom </span>
                <span className="relative inline-block">
                  <span className="text-blue-600 dark:text-blue-400">Chatbot</span>
                  <svg
                    className="absolute left-0 bottom-0 fill-blue-200 dark:fill-blue-500 w-full h-[1.2em] z-[-1] -rotate-3"
              ...
              <div className="max-w-xs mx-auto sm:max-w-none sm:inline-flex sm:justify-center space-y-4 sm:space-y-0 sm:space-x-4">
                ...
                <Link href="/demo" className="btn-sm text-white bg-gradient-to-r from-purple-600 to-pink-500 hover:bg-pink-500 px-6 py-3 rounded-full transition duration-200 ease-in-out">
                  View Demo
                </Link>
              </div>
            </div>

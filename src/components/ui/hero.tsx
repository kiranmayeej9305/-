...
export default function Hero() {
  ...
  return (
    <section className="relative before:absolute before:inset-0 before:h-80 before:pointer-events-none before:bg-gradient-to-b before:from-zinc-100 dark:before:from-zinc-800 before:-z-10">
      <div className="pt-32 pb-12 md:pt-40 md:pb-20">
        {/* Section content */}
        <div className="px-4 sm:px-6">
          <div className="max-w-3xl mx-auto">
            <div className="text-center pb-12 md:pb-16">
              <h1 className="font-inter-tight text-4xl md:text-5xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-zinc-500 via-zinc-900 to-zinc-900 dark:from-zinc-300 dark:via-zinc-600 dark:to-zinc-600 pb-4">
                The creative <em className="italic relative inline-flex justify-center items-center text-zinc-900 dark:text-zinc-100"> platform
                  <svg className="absolute fill-zinc-300 dark:fill-zinc-600 w-[calc(100%+1rem)] -z-10" xmlns="http://www.w3.org/2000/svg" width="223" height="62" viewBox="0 0 223 62" aria-hidden="true" preserveAspectRatio="none">
              ...
              <p className="text-lg text-zinc-500 dark:text-zinc-300 mb-8">
              ...
              <div className="max-w-xs mx-auto sm:max-w-none sm:inline-flex sm:justify-center space-y-4 sm:space-y-0 sm:space-x-4">
                <div>
                  <Link href="/signin" className="btn-sm text-white bg-black dark:bg-white dark:text-black hover:bg-gray-800 dark:hover:bg-gray-300 px-4 py-2 rounded-full transition duration-150 ease-in-out">
                    Try for Free
                  </Link>
                </div>
              </div>
        ...
        {/* Image */}
        <div className="max-w-6xl mx-auto px-4 sm:px-6 flex justify-center pb-12 md:pb-20 relative before:absolute before:-top-12 before:w-96 before:h-96 before:bg-zinc-900 dark:before:bg-zinc-100 before:opacity-[.15] before:rounded-full before:blur-3xl before:-z-10">
